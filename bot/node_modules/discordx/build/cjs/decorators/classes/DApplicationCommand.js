...
exports.DApplicationCommand = void 0;
 ...
 * @category Decorator
 */
class DApplicationCommand extends Method_js_1.Method {
    _botIds;
    _name;
    _nameLocalizations;
    _description;
    ...
    toJSON() {
        const options = [...this.options]
            .reverse()
            .sort((a, b) => {
            if ((a.type === discord_js_1.ApplicationCommandOptionType.Subcommand ||
                a.type === discord_js_1.ApplicationCommandOptionType.SubcommandGroup) &&
                (b.type === discord_js_1.ApplicationCommandOptionType.Subcommand ||
                    b.type === discord_js_1.ApplicationCommandOptionType.SubcommandGroup)) {
...
exports.DApplicationCommand = DApplicationCommand;
