...
class MetadataStorage {
    ...
    async build() {
        ...
        this._events.sort((a, b) => `${a.event}__${a.priority}` > `${b.event}__${b.priority}` ? 1 : -1);
    }
    buildSimpleCommands() {
    ...
    groupSlashes() {
        ...
        this._applicationCommandSlashGroups.forEach((group) => {
            ...
            const slashParent = index_js_1.DApplicationCommand.create({
        ...
        this._applicationCommandSlashSubGroups.forEach((subGroup) => {
            if (!subGroup.payload.description) {
                throw Error(`Description required for slash sub group: ${subGroup.name} (root: ${subGroup.root ?? "unknown"})`);
            }
