...
abstract class OpenParticipation {
  ...
  @Guard(isAdmin)
  public openSubscription(@SlashOption("tournament", { description: "Nom du tournoi à configurer", autocomplete: autocompleteTournaments, type: "STRING", required: true}) tournamentName: string, interaction: CommandInteraction): void {
